...
from app.config.connection_pool import release_connection
...
class UserRepository:
    ...
    def find_by_fitbit_user_id(self, fitbit_user_id: str) -> User | None:
        try:
            ...
            logger.error("find by fitbit_user_id failed", exc_info=True)
        finally:
    ...
    def update_tokens(
        ...
        try:
            ...
            logger.error("update token failed", exc_info=True)
        finally:
            release_connection(self.conn)
