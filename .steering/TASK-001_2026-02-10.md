...
- [x] Step 1: ディレクトリ構成の作成
- [x] Step 2: `backend/pom.xml` の作成
- [x] Step 3: エントリポイントの作成
- [x] Step 4: 設定ファイルの作成
- [x] Step 5: パッケージ構成スケルトンの作成
- [x] Step 6: `backend/.gitignore` の作成
- [x] 最終確認: `mvn compile` が成功する
...
3つの YAML 設定ファイルを作成する（テスト環境用は不要）。
