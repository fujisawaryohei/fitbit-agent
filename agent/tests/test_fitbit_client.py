...
class TestGet:
    ...
    def test_get_activities_success(self, client: FitbitClient) -> None:
    ...
    def test_get_heart_rate_with_period(self, client: FitbitClient) -> None:
        with patch("httpx.get", return_value=self._mock_response(200, {})) as mock_get:
